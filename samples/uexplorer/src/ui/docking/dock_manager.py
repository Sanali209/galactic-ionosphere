...
class DockManager:
    ...
    def create_panel(self, name: str) -> Optional[BasePanelWidget]:
        ...
        # Get locator from config (assumes ConfigManager has locator attr)
        # Or we can require panels to not need locator in constructor
        # For now, we'll pass config as locator since panels need service access
