...
# Use app module references that are already loaded
...
async def search_images_handler(query: str, count: str):
    ...
    try:
        ...
        import app_search_service
        SearchService = app_search_service.SearchService
        ...
        search_history.downloaded_count = 0
